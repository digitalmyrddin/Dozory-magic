...
— **HotKeys**:
Позволяет назначить любые клавиши (1, 2, и тд.) на заклинания в быту. Кнопка ⌨ в панели действий открывает настройки. Автодополнение по названию заклинания на рефлексе.
